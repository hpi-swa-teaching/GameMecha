A Cache is an Object that "loads elements" only when they are needed, and if they are not loaded yet. It can be used for any kind of Object, like Images, sounds, Levels of your own game etc...
